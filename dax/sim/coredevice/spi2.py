...
from artiq.coredevice.spi2 import SPIMaster as _SPIMaster
...
class SPIMaster(DaxSimDevice, _SPIMaster):
    ...
    def __init__(self, dmgr: typing.Any, channel, **kwargs):
    ...
    def _init_spi_device(self, channel, div: int = 0, length: int = 0):
